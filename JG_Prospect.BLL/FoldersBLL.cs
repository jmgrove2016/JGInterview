...
namespace JG_Prospect.BLL
{
    public class FoldersBLL
    {
        ...
        {
            return FoldersDAL.Instance.GetFoldersByDesgId(designationId);
        }
        ...
        {
            return FoldersDAL.Instance.DeleteFolders(folderId);
        }
        ...
        {
            return FoldersDAL.Instance.InsertFolders(name, designationId, userId);
        }
    }
}
