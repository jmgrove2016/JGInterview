...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../css/flags24.css" rel="stylesheet" />
                ...
                <div class="form_panel_custom">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <label>
                                            ...
                                            <asp:Label ID="lblReqDesig" ForeColor="Red" runat="server" Text="*"></asp:Label>
                                            >
                                        </label>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <table style="margin-left: 0px;">
                                            <tr>
                                                <td style="vertical-align: top; width: 220px; padding-right: 0px !important;">First Name
                                                <span>
                                                    <asp:Label ID="lblReqFName" Text="*" ForeColor="Green" runat="server"></asp:Label>
                                                </span>
                                                    <br />
                                                ...
                                                <td style="vertical-align: top; width: 220px;">Last Name
                                                <span>
                                                    <asp:Label ID="lblReqLastName" Text="*" runat="server" ForeColor="Green"></asp:Label>
                                                </span>
                                                ...
                                                <td style="padding-right: 0px !important;">Phone#
                                                ...
                                                <td>&nbsp;&nbsp;Ext. <%--extension--%>
                                                    <br />
                                                    <asp:TextBox ID="txtPhoneExt" runat="server" MaxLength="8" Width="25"></asp:TextBox>
                                                </td>
                                                ...
                                                <td style="vertical-align: top; padding-right: 0px !important;">Email
                                                <span>
                                                    <asp:Label ID="lblReqEmail" Text="*" runat="server" ForeColor="Red"></asp:Label>
                                                </span>
                                                    <br />
                                ...
                                <tr>
                                    ...
                                    <asp:Button runat="server" ID="btnDeleteSource" OnClientClick="javascript:return confirm('are you sure you want to delete this source? All users entered by this source will be replaced with JG - Source by default.');" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" Text="Delete" OnClick="btnDeleteSource_Click" CausesValidation="false" Height="30px" />
                                        ...
                                        <asp:RequiredFieldValidator ID="rqSource" runat="server" ControlToValidate="ddlSource" InitialValue="0"
                                            ForeColor="Red" Display="Dynamic" ValidationGroup="submit">Enter Source</asp:RequiredFieldValidator>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Employee Type                                        
                                    <span>
                                        <asp:Label ID="lblReqEmpType" Text="*" ForeColor="Blue" runat="server"></asp:Label>
                                    </span>
                                        <br />
                        ...
                        <li style="width: 99%;">
                            ...
                            <table id="tblSkillAssessment" class="tblSkillAssessment">
                                <tr>
                                    ...
                                    <br />
                                        <br />
                                        <asp:RadioButton ID="rdoCompLitYes" runat="server" Text="Yes" GroupName="CompLit" />
                                        <%--TabIndex="188"--%>
                                        <asp:RadioButton ID="rdoCompLitNo" runat="server" Text="No" GroupName="CompLit" />
                                        <%--TabIndex="189"--%> 
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <br />
                                        <br />
                                        <asp:RadioButton ID="rdoFELONYYes" runat="server" Text="Yes" GroupName="FELONY" />
                                        <%--TabIndex="188"--%>
                                        <asp:RadioButton ID="rdoFELONYNo" runat="server" Text="No" GroupName="FELONY" />
                                        <%--TabIndex="189" --%>
                                    </td>
                                    <td class="auto-style15">Why are you the best candidate for the job?
                                    <br />
                                        <br />
                                        <asp:TextBox ID="txtWhyBest" runat="server" Width="251px"></asp:TextBox>
                                        <%-- TabIndex="197"--%>
                                    </td>
                                </tr>
                                <%--<tr>
                            ...
                            <table class="tblRecruiterAssMinusNew">
                                <tr>
                                    ...
                                    <br />
                                        <br />
                                        <asp:TextBox ID="txtTalentVenues" runat="server" Width="251px" TextMode="MultiLine" Height="47px"></asp:TextBox>
                                        <%-- TabIndex="197"--%>
                                    </td>
                                    <td>Do you have a license? 
                                    &nbsp;&nbsp;&nbsp;
                                    <asp:RadioButton ID="rdoLicenseYes" runat="server" Text="Yes" GroupName="License" />
                                        <%--TabIndex="190" --%>
                                        <asp:RadioButton ID="rdoLicenseNo" runat="server" Text="No" GroupName="License" />
                                        <%--TabIndex="191"--%>
                                        <br />
                                        <br />
                                        <br />
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <br />
                                                    <br />
                                                    a.
                                                <asp:TextBox ID="aone" runat="server" Width="63px"></asp:TextBox>
                                                    Perimeter=
                                                <asp:TextBox ID="txtaonetwo" runat="server" Width="99px"></asp:TextBox>
                                                    <br />
                                                    <br />
                                                    b.
                                                <asp:TextBox ID="bOne" runat="server"></asp:TextBox>
                                                    <br />
                                                    <br />
                                                    c.
                                                <asp:TextBox ID="cOne" runat="server"></asp:TextBox>
                                                    <br />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <br />
                                                    <br />
                                                    a.
                                                <asp:TextBox ID="txtaThree" runat="server" Width="63px"></asp:TextBox>
                                                    Perimeter=
                                                <asp:TextBox ID="txtaThreeTwo" runat="server" Width="99px"></asp:TextBox>
                                                    <br />
                                                    <br />
                                                    b.
                                                <asp:TextBox ID="txtbThree" runat="server"></asp:TextBox>
                                                    <br />
                                                    <br />
                                                    c.
                                                <asp:TextBox ID="txtcThree" runat="server"></asp:TextBox>
                                                    <br />
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <label>
                                                        Resume:</label>
                                                    <asp:FileUpload ID="flpResume" runat="server" Width="221px" Height="25px" />
                                                    <%--TabIndex="198"--%>
                                                &nbsp;
                                                <asp:Button ID="btnResume" runat="server" CssClass="cancel" Width="10%" Text="Upload" Height="25px" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" OnClick="btnResume_Click" OnClientClick="return ValidateFileOne()" />
                                                    <%--TabIndex="199"--%>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <br />
                                                    ...
                                                    <br />
                                                    a.
                                                <asp:TextBox ID="aTwo" runat="server" Width="63px"></asp:TextBox>
                                                    Perimeter=
                                                <asp:TextBox ID="txtaTwotwo" runat="server" Width="99px"></asp:TextBox>
                                                    <br />
                                                    <br />
                                                    b.
                                                <asp:TextBox ID="bTwo" runat="server"></asp:TextBox>
                                                    <br />
                                                    <br />
                                                    c.
                                                <asp:TextBox ID="cTwo" runat="server"></asp:TextBox>
                                                    <br />
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <li style="width: 99%;">
                            <table class="tblBasicAssessment" border="0" cellspacing="0" cellpadding="0" style="margin-left: 0;">
                                ...
                                <tr>
                                    ...
                                    <asp:RadioButton Width="45px" ID="rdoCurrentlyEmployeedYes" runat="server" Text="Yes" GroupName="rdoCrEmp" />
                                        <%--TabIndex="190"--%>
                            ...
                            <li style="width: 49%;">
                                <asp:Panel ID="pnlnewHire" runat="server">
                                    <table border="0" class="tblNewHire" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="height: 50px;">
                                                <label>
                                                    Hire Date
                                                <span>
                                                    <asp:Label ID="lblReqHireDate" runat="server" Text="*" ForeColor="Blue"></asp:Label>
                                                </span>
                                                </label>
                                                <asp:TextBox ID="txtHireDate" Enabled="false" runat="server" Width="231px"></asp:TextBox>
                                                <%-- TabIndex="151"--%>
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    Workers Comp Code
                                                <span>
                                                    <asp:Label ID="lblReqWWC" Text="*" runat="server" ForeColor="Blue"></asp:Label>
                                                </span>
                                                </label>
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    Pay Rates
                                                <span>
                                                    <asp:Label ID="lblReqPayRates" Text="*" ForeColor="Blue" runat="server"></asp:Label>
                                                </span>
                                                    $
                                                </label>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:RadioButton ID="rdoCheque" runat="server" AutoPostBack="true" GroupName="paymethod" Text="Check" OnCheckedChanged="rdoCheque_CheckedChanged" Checked="True" />
                                                <%--TabIndex="166" --%>
                                                <asp:RadioButton ID="rdoDeposite" runat="server" GroupName="paymethod" Text="Direct Deposite" OnCheckedChanged="rdoDeposite_CheckedChanged" AutoPostBack="True" />
                                                <%-- TabIndex="167"--%>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table border="0" class="tblNewHire" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="height: 50px;">
                                                ...
                                                <asp:Label ID="lblTermination" runat="server" ForeColor="Red" Text="*"></asp:Label>
                                                </label>
                                        ...
                                        <tr>
                                            <td class="auto-style15">
                                                <label>
                                                    Next Review Date
                                                <asp:Label ID="lblNextReviewDate" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                                </label>
                                        ...
                                        <tr>
                                            <td class="auto-style15">
                                                <label>
                                                    Last Review Date
                                                <asp:Label ID="lblLastReview" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                                </label>
                                        ...
                                        <tr>
                                            ...
                                            <label style="width: 2%;">
                                                ...
                                                <br />
                                                <label>
                                                    <asp:Label ID="lblExtraEarning" ForeColor="Black" runat="server"> Extra Earnings</asp:Label>
                                                </label>
                                                <label>
                                                ...
                                                <label>
                                                    &nbsp;&nbsp;&nbsp;
                                                <asp:Label ID="lblDoller" ForeColor="Black" runat="server"></asp:Label>
                                                </label>
                                                <br />
                                                <label>
                                                </label>
                                        ...
                                        <tr>
                                            <td class="auto-style15">
                                                <asp:Button ID="btnAddExtraIncome" ValidationGroup="SubmitNew" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" runat="server" Text="Add" Height="28px" Width="55px" OnClick="btnAddExtraIncome_Click" />
                                                <%--TabIndex="160" --%>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <label style="width: 45px;">
                                                Reason</label>
                                                <asp:TextBox ID="txtDeducReason" runat="server" Width="113px"></asp:TextBox>
                                                <%-- TabIndex="162"--%>
                                            &nbsp;
                                            <%--</ContentTemplate>
                                                <Triggers>
                                        ...
                                        <tr>
                                            <td class="auto-style15">
                                                ...
                                                <ContentTemplate>--%>
                                                <asp:Button ID="btnAddType" runat="server" Height="28px" OnClick="btnAddType_Click" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" Text="Add" ValidationGroup="Add" Width="55px" />
                                                <%--TabIndex="165" --%>
                                                <%--</ContentTemplate>
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="btnAddType" EventName="Click" />
                                    ...
                                    <td colspan="1">
                                        <div style="float: left">
                                            <label style="display: none;">
                                                Password
                                            <asp:Label ID="lblPassReq" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                            </label>
                                            Password<br />
                                        ...
                                        <div style="float: right">
                                            <label style="display: none;">
                                                Confirm Password
                                            <asp:Label ID="lblConfirmPass" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                            </label>
                                            Confirm Password<br />
                                                    ...
                                                    <table class="tblGen-Secon">
                                                        <tr>
                                                            ...
                                                            <br />
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtMailingAddress"
                                                                    ForeColor="Blue" Display="Dynamic" ValidationGroup="submit">Enter Mailing Address</asp:RequiredFieldValidator>
                                                                <br />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <label>
                                                                    SSN
                                                                <asp:Label ID="lblReqSSN" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                                                </label>
                        ...
                        <li style="width: 49%;">
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Label ID="lblInstallerType" ForeColor="Black" runat="server" Text="Installer Type"></asp:Label>
                                        </label>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <label>
                                            ...
                                            <asp:Label ID="lblReqSig" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                        </label>
                                ...
                                <tr>
                                    <td class="style2">
                                        ...
                                        <label>
                                            ...
                                            <asp:Label ID="lblReqMarSt" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                        </label>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <label>
                                            DL License
                                        <span>
                                            <asp:Label ID="lblReqDL" runat="server" Text="*" ForeColor="Red" Style="margin-top: -14px; margin-left: 63px"></asp:Label>
                                        </span>
                                        </label>
                                        <%--    </ContentTemplate>
                                        <Triggers>
                                        ...
                                        <asp:Button ID="btnPqLicense" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" runat="server" CssClass="cancel"
                                            Width="10%" Text="Upload" OnClick="btnPqLicense_Click" />
                                        <%--TabIndex="142"--%>
                                        <%--</ContentTemplate>
                                        <Triggers>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:Button ID="btn_UploadFiles" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" runat="server" CssClass="cancel"
                                            Width="10%" Text="Upload" OnClick="btn_UploadFiles_Click" />
                                        <%--TabIndex="144"--%>
                                        <%-- </ContentTemplate>
                                        <Triggers>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="style1">
                                        ...
                                        <ContentTemplate>--%>
                                        <label></label>
                                        <asp:TextBox ID="txtReson" placeholder="Reason" runat="server" Height="28px" TextMode="MultiLine" Width="257px"></asp:TextBox>
                                        <%--TabIndex="103"--%>
                                ...
                                <tr>
                                    <td class="style2" style="display: none;">
                                        ...
                                        <asp:RequiredFieldValidator ID="rqAddress" runat="server" ControlToValidate="txtaddress"
                                            ForeColor="Red" Display="Dynamic" ValidationGroup="submit">Enter Address</asp:RequiredFieldValidator>
                                        <br />
                                    </td>
                                </tr>
                                <%--<tr>
                    ...
                    <div>
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        <%--<asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                        <ContentTemplate>--%>
                                                        <asp:Button ID="btnPluse" runat="server" Text="+" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" OnClick="btnPluse_Click" Font-Size="Medium" Width="23px" />
                                                        <%-- TabIndex="146"--%>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkboxcondition" runat="server" />
                                    <%--TabIndex="148" --%>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:Button ID="Button2" runat="server" BackColor="#327FB5" ForeColor="White" Height="32px"
                                        ...
                                        ValidationGroup="IndiCred" OnClick="No_Click" />
                                    <%--TabIndex="119"--%>
                        ...
                        <table width="100%" style="border: Solid 3px #b04547; width: 100%; height: 300px;"
                            ...
                            <tr>
                                <td align="right" style="height: 15px;">
                                    ...
                                    <label>
                                        Email
                                    <span>
                                        <asp:Label ID="lblOfferReqEmail" Text="*" runat="server" ForeColor="Red"></asp:Label>
                                    </span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="right" style="height: 15px;">
                                    <label>
                                        Password
                                    <asp:Label ID="lblOfferPassword" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                    </label>
                                </td>
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtOfferPassword"
                                        ValidationGroup="OfferPopUp" ForeColor="Red" Display="Dynamic" ErrorMessage="Please Enter Password"></asp:RequiredFieldValidator>
                                    <br />
                                </td>
                            </tr>
                            <tr>
