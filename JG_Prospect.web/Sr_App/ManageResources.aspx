...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <li data-ng-repeat="subModule in module.Categories">
                                 ...
                                 <ul class="tree-child-files">
                                     <li data-ng-repeat="subModule1 in subModule.Categories">
                                         <img src="../img/delete-black.png" class="icons" ng-click="DeleteFiles(subModule1.ID)" />
                                         {{subModule1.Title}}
    ...
    <script>
        ...
        function applydropzone(btnClick) {
            ...
            objworkfiledropzone = GetWorkFileDropzone("div#divBulkUploadFile", 'div#divBulkUploadFilePreview', '#<%= hdnBulkUploadFile.ClientID %>', btnClick,true);
        }
