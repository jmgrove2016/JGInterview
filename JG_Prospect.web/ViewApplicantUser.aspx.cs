...
{
    public partial class ViewApplicantUser : System.Web.UI.Page
    {
        #region '--Members--'
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                if (Request.QueryString["Id"].ToString() != JGSession.LoginUserID)
                {
                    Response.Redirect("~/ViewApplicantUser.aspx?Id=" + JGSession.LoginUserID);
                }
