...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="OppUnlocked" data-ng-controller="PostApptitude">
        ...
        <div id="appstage" class="sectiondiv">
            <h3 class="bold-header">Application stage - Apptitude test cleared!</h3>
        </div>
        ...
        <div id="weltext" class="sectiondiv">
            <div class="text-block">
                Confirm your contact info is correct! To edit your profile, select your IMG or ID# top right-hand corner anytime.
            </div>
        </div>
        <!-- Welcome text ends -->
        ...
        <div id="tandr" class="sectiondiv clearfix">
            ...
            <div id="tnrDisplay">
                <video id="def-intro" class="video-js video-js-opp" controls data-setup="{}">
                        <p class="vjs-no-js">
