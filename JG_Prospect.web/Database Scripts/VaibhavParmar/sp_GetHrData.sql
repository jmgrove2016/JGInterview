...
-- [sp_GetHrData] 'yogesh.kelariya@hotmail.com','0',0,0, 0, NULL, NULL,0,20, 'CreatedDateTime DESC','5','9','6','1'  
...
SET NOCOUNT ON;  
 ...
 ISNULL (t.UserInstallId,t.id) END),ISNULL(t.UserInstallId,t.id)) As UserInstallId,  
